...
""" 
Utilizado por EMISOR. 
Genera un diccionario Python que contiene al string JSON proporcionado y una firma hash de su contenido.
...
"""
Utilizado por RECEPTOR,
para validar la autenticidad e integridad del mensaje.
...
@return: 
  - True si: 
    1) se comprueba que se usó la misma clave secreta
    2) se comprueba la integridad del mensaje
  - False en otro caso
"""
